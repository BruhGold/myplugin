...
class UserDataForm extends moodleform {
    ...
    function definition() {
        ...
        $mform->addHelpButton('comment_download', 'downloadcommentshelp', 'local_myplugin');

        // submissions
        $mform->addElement('advcheckbox', 'submission_download', 'download submissions?',' ');
        $mform->addHelpButton('submission_download', 'downloadsubmissionshelp', 'local_myplugin');
